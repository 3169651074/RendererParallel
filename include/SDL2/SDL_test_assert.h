...
/*
 *
 * Assert API for life_game code and life_game cases
 *
 */
...
/*
 * \brief Assert for life_game cases that logs but does not break execution flow on failures. Updates assertion counters.
 *
 * \param assertCondition Evaluated condition or variable to assert; fail (==0) or pass (!=0).
 * \param assertDescription Message to log with the assert describing it.
 *
...
/*
 * \brief Converts the current assert summary state to a life_game result.
 *
