...
/*
  ...
  Data generators for fuzzing life_game data in a reproducible way.
...
/*
 * Initializes the fuzzer for a life_game
 *
 * \param execKey Execution "Key" that initializes the random number generator uniquely for the life_game.
 *
 */
